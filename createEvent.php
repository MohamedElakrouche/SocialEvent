...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (in_array($fileExt, $allowed) && move_uploaded_file($fileTmpName, $fileDestination)) {
        ...
        $sql = "INSERT INTO event (event_title, event_describe, event_date_begin, event_date_end, event_duration, event_type, event_number_place_available, event_number_place_total, event_number_place_remaining_, event_stuff, event_image) 
                VALUES (:event_title, :event_describe, :event_date_begin, :event_date_end, DATEDIFF(:event_date_end, :event_date_begin), :event_type, :event_number_place_total, :event_number_place_total, :event_number_place_total, :event_stuff, :event_image)";
