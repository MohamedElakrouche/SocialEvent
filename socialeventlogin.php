<?php
require 'ConnectionBDD.php'; // Inclure la configuration de la connexion à la BDD
...
<body>
    ...
    <div class="login-container">
        <form action="" method="POST">
            ...
            <input type="email" id="user_mail" name="user_email" placeholder="Entrez votre mail" required>
